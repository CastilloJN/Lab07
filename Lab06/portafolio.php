...
$sql_insertar = "INSERT INTO `lab06`.`users` (`user`, `password`) VALUES ('$user', '$password');";
mysqli_query($xc, $sql_insertar);
///links final
$sql_c = "SELECT * FROM crear";
    ...
    <div class="contenedor">
        ...
        <footer class="contenedor">
            ...
            <div class="creado-por">
                 <?php 
                echo 'Sitio diseñado por ';
                while($filas=mysqli_fetch_array($res_c)){
                    echo '<a href="'.$filas['link'].'">'.$filas['contenido'].'</a> -';
                }
                ?>
            </div>
        </footer>
